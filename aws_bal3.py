...
if counter == 3:
    ...
    #check if app1 status is up
    while True:
        if check_status('i-02aa1098e70254776') in 'OutOfService':
            print("exit while")
            print("x " + check_status('i-02aa1098e70254776'))
            break
        else:
            print("i-02aa1098e70254776 is InService - in DEPOLY-  going to sleep 2 seconds..")
            print("im here")
            print("y " + check_status('i-02aa1098e70254776'))
            sleep(2)


    #check if app1 status is down
    while True:
        if check_status('i-02aa1098e70254776') == 'OutOfService':
